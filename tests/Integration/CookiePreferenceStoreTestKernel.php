...
final class CookiePreferenceStoreTestKernel extends Kernel
{
    ...
    {
        return $this->getProjectDir() . '/var/cache/cookie_store_kernel';
    }
    ...
    protected function configureContainer(ContainerConfigurator $container): void
    {
        ...
        $container->extension('symfinity_ux_blocks_core', ['fragment_ids' => false]);
        $container->extension('symfinity_ux_blocks_form', ['fragment_ids' => false]);
        ...
        $container->extension('twig', [
            ...
            'paths' => [
                __DIR__ . '/templates' => 'IntegrationTest',
            ],
        ]);
    ...
    protected function configureRoutes(\Symfony\Component\Routing\Loader\Configurator\RoutingConfigurator $routes): void
    {
        ...
        $routes->add('home', '/')
            ...
            ->defaults(['template' => '@IntegrationTest/consent.html.twig'])
            ->methods(['GET']);
    }
}
