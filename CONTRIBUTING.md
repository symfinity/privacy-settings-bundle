# Contributing to Privacy Settings Bundle

> **Read-only mirror.** This repository (`symfinity/privacy-settings-bundle`) is published from the Symfinity product monorepo (`packages/privacy-settings-bundle/`). **Do not expect pull requests to be merged here.**

## Report bugs or request features

Open an [issue](https://github.com/symfinity/privacy-settings-bundle/issues) on this repository.
...
Open a pull request on the **product monorepo** (`packages/privacy-settings-bundle/`) on a `feature/{spec-id}-{slug}` branch. Do not rely on merging on this mirror.
